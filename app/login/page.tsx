...
import { Input, Label } from "@/components/ui/TextComponents";
...
export default function AuthPage() {
  ...
  const handleSubmit: React.FormEventHandler = async (e) => {
    ...
    const dataToSend = isLogin ? { username: formData.email, password: formData.password } : { username: formData.email, email: formData.email, password: formData.password };
